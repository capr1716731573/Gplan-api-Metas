...
//DATOS DE LA TABLA
var datos_tabla = {
    tabla_target: 'empresa',
    pk_tabla: 'pk_empre',
    sp_crud_tabla: 'sp_crud_empresa'
}
...
app.get('/busqueda', mdAuthenticationJWT.verificarToken, (req, res, next) => {
    ...
    var consulta;
    //valido que exista el parametro "desde"
    consulta = `SELECT * FROM ${ datos_tabla.tabla_target } WHERE nombre_empre LIKE '%${busqueda}%' OR direccion_empre LIKE '%${busqueda}%'`;
